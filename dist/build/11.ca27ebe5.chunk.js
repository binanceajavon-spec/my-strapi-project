"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[11],{
...
var esm_typeof = __webpack_require__(10570);
// EXTERNAL MODULE: ./node_modules/date-fns/esm/_lib/requiredArgs/index.js
var requiredArgs = __webpack_require__(94683);
...
var toDate = __webpack_require__(26335);
...
var toInteger = __webpack_require__(75704);
...
var addLeadingZeros = __webpack_require__(6355);
...
var formatters = {
  ...
  y: function y(date, token) {
    ...
    return (0,addLeadingZeros/* default */.A)(token === "yy" ? year % 100 : year, token.length);
  },
  // Month
  M: function M(date, token) {
    var month = date.getUTCMonth();
    return token === "M" ? String(month + 1) : (0,addLeadingZeros/* default */.A)(month + 1, 2);
  },
  // Day of the month
  d: function d(date, token) {
    return (0,addLeadingZeros/* default */.A)(date.getUTCDate(), token.length);
  },
  // AM or PM
  ...
  h: function h(date, token) {
    return (0,addLeadingZeros/* default */.A)(date.getUTCHours() % 12 || 12, token.length);
  },
  // Hour [0-23]
  H: function H(date, token) {
    return (0,addLeadingZeros/* default */.A)(date.getUTCHours(), token.length);
  },
  // Minute
  m: function m(date, token) {
    return (0,addLeadingZeros/* default */.A)(date.getUTCMinutes(), token.length);
  },
  // Second
  s: function s(date, token) {
    return (0,addLeadingZeros/* default */.A)(date.getUTCSeconds(), token.length);
  },
  // Fraction of second
  S: function S(date, token) {
    ...
    return (0,addLeadingZeros/* default */.A)(fractionalSeconds, token.length);
  }
};
...
var getTimezoneOffsetInMilliseconds = __webpack_require__(83960);
