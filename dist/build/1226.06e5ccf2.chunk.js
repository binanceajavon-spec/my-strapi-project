"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[1226],{
...
const it = {
  ...
  "attribute.boolean.description": "S\xEC o no, 1 o 0, vero o falso",
  ...
  "button.single-types.create": "Crea nuova Entit\xE0 singola",
  "component.repeatable": "(ripetibile)",
  "components.componentSelect.no-component-available": "Hai gi\xE0 aggiunto tutti i componenti",
  ...
  "error.attributeName.reserved-name": "Questo nome non pu\xF2 essere utilizzato nel tuo Tipo di Contenuto perch\xE9 potrebbe danneggiare altre funzionalit\xE0",
  "error.contentTypeName.reserved-name": "Questo nome non pu\xF2 essere utilizzato nel tuo progetto perch\xE9 potrebbe danneggiare altre funzionalit\xE0",
  "error.validation.enum-duplicate": "Valori duplicati non ammessi",
  "error.validation.minSupMax": "Non pu\xF2 essere maggiore",
  "error.validation.regex": "Regex non valida",
  "error.validation.relation.targetAttribute-taken": "Questo nome gi\xE0 esiste nella destinazione",
  ...
  "form.attribute.component.option.reuse-existing.description": "Riutilizza un componente gi\xE0 creato per mantenere i dati consistenti tra i vari Tipi di Contenuto",
  ...
  "form.attribute.item.privateField.description": "Questo campo non sar\xE0 presente nelle risposte API",
  "form.attribute.item.requiredField": "Campo obbligatorio",
  "form.attribute.item.requiredField.description": "Non sarai in grado di creare una voce se questo campo \xE8 vuoto",
  ...
  "form.attribute.item.uniqueField.description": "Non sarai in grado di creare una voce, se c'\xE8 una voce esistente con valore identico",
  ...
  "form.attribute.text.option.long-text.description": "Utile per descrizioni o biografie. La ricerca esatta \xE8 disabilitata.",
  ...
  "form.button.add.field.to.singleType": "Aggiungi un altro campo a questa Entit\xE0 singola",
  ...
  "form.button.single-type.description": "Indicato per entit\xE0 uniche come home page, chi siamo, ecc...",
  from,
  ...
  "modalForm.singleType.header-create": "Crea una Entit\xE0 singola",
  ...
  "modalForm.sub-header.chooseAttribute.singleType": "Seleziona un campo per la tua Entit\xE0 singola",
  "modelPage.attribute.relation-polymorphic": "Relazione (polimorfica)",
  "modelPage.attribute.relationWith": "Relazione con",
  "notification.info.autoreaload-disable": "La funzionalit\xE0 autoReload \xE8 richiesta per usare questo plugin. Avvia il tuo server con `strapi develop`",
  ...
  "popUpWarning.draft-publish.button.confirm": "S\xEC, disabilita",
