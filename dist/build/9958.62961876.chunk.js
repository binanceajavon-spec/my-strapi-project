"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[9958],{
...
const it = {
  ...
  "form.input.decription.file-alt": "Questo testo viene mostrato quando la risorsa non pu\xF2 essere visualizzata.",
  "form.input.label.file-alt": "Testo alternativo",
  "form.input.label.file-caption": "Didascalia",
  "form.input.label.file-name": "Nome file",
  "form.upload-url.error.url.invalid": "Un URL non \xE8 valido",
  ...
  "list.assets.type-not-allowed": "Questo tipo di file non \xE8 consentito.",
  ...
  "modal.upload-list.sub-header.button": "Aggiungi pi\xF9 risorse",
  ...
  "settings.form.sizeOptimization.label": "Abilita ottimizzazioni di qualit\xE0 (senza perdita di qualit\xE0)",
  ...
  "sort.created_at_asc": "Upload pi\xF9 vecchi",
  ...
  "sort.updated_at_asc": "Aggiornamenti pi\xF9 vecchi",
