"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[6511],{
...
const dk = {
  ...
  "EditForm.inputToggle.description.email-confirmation": "N\xE5r aktiv (TIL), modtager nye registrerede brugere en bekr\xE6ftelses e-mail.",
  "EditForm.inputToggle.description.email-confirmation-redirection": "Efter bekr\xE6ftet email, v\xE6lg hvor du vil omdirigeres til.",
  "EditForm.inputToggle.description.email-reset-password": "URL til din apps nulstil kodeord side",
  "EditForm.inputToggle.description.sign-up": "N\xE5r deaktiveret (FRA), er registrering forbudt. Ingen kan subscribe uanset udbyder.",
  "EditForm.inputToggle.label.email": "En bruger pr. e-mail",
  "EditForm.inputToggle.label.email-confirmation": "Aktiv\xE9r e-mail bekr\xE6ftelse",
  ...
  "EditForm.inputToggle.label.sign-up": "Aktiv\xE9r oprettelser",
  ...
  "Email.template.email_confirmation": "E-mail adresse bekr\xE6ftelse",
  "Email.template.form.edit.label": "Redig\xE9r en skabelon",
  ...
  "Plugin.permissions.plugins.description": "Defin\xE9r alle tilladte handlinger for {name} plugin.",
  "Plugins.header.description": "Kunne handlinger tilknyttet en rute er vist nedenfor.",
  "Plugins.header.title": "Rettigheder",
  "Policies.header.hint": "V\xE6lg applikationens handlinger eller plugin handlinger og klik p\xE5 tandhjulet for at vise den bunde rute",
  "Policies.header.title": "Advancerede indstillinger",
  "PopUpForm.Email.email_templates.inputDescription": "Hvis du er usikker p\xE5 brugen af variabler, {link}",
  ...
  "PopUpForm.Email.options.object.placeholder": "Bekr\xE6ft venligst din e-mail adresse for %APP_NAME%",
  ...
  "PopUpForm.Providers.enabled.label": "Aktiv\xE9r",
  ...
  "PopUpForm.Providers.redirectURL.label": "Omstillings URL som tilf\xF8jes til din {provider} applikation konfigurationer",
  ...
  "PopUpForm.header.edit.email-templates": "Redig\xE9r e-mail skabeloner",
  "PopUpForm.header.edit.providers": "Redig\xE9r udbydere",
  "Providers.data.loaded": "Providers hentet",
  "Providers.status": "Status",
  "Roles.empty": "Du har endnu ingen roller.",
  "Roles.empty.search": "Ingen roller matcher s\xF8gningen.",
  ...
  "components.Input.error.validation.max": "V\xE6rdien er for h\xF8j.",
  "components.Input.error.validation.maxLength": "V\xE6rdien er for lang.",
  "components.Input.error.validation.min": "V\xE6rdien er for lav.",
  "components.Input.error.validation.minLength": "V\xE6rdien er for kort.",
  "components.Input.error.validation.minSupMax": "Kan ikke v\xE6re overlegen",
  "components.Input.error.validation.regex": "V\xE6rdien stemmer ikke overens med regex.",
  "components.Input.error.validation.required": "V\xE6rdien er p\xE5kr\xE6vet.",
  "components.Input.error.validation.unique": "V\xE6rdien er allerede brugt.",
  "notification.success.submit": "Indstillingerne er blevet opdateret",
  "page.title": "Indstillinger - Roller",
  "plugin.description.long": "Beskyt din API med fuld godkendelse med JWT. Dette plugin kommer ogs\xE5 med en ACL strategi som tillader dig at h\xE5ndtere rettigeheder mellem grupper af brugere.",
  ...
  "popUpWarning.button.confirm": "Bekr\xE6ft",
  "popUpWarning.title": "Bekr\xE6ft venligst",
  "popUpWarning.warning.cancel": "Er du sikker p\xE5 at du vil annullere dine \xE6ndringer?"
};
