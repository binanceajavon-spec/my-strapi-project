"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[7690],{
...
/* harmony export */ });
const de = {
  "bulk.select.label": "W\xE4hle alle Dateien aus",
  "button.next": "Weiter",
  ...
  "control-card.add": "Hinzuf\xFCgen",
  ...
  "filter.add": "Filter hinzuf\xFCgen",
  ...
  "form.upload-url.error.url.invalid": "Eine URL ist ung\xFCltig",
  "form.upload-url.error.url.invalids": "{number} URLs sind ung\xFCltig",
  "header.actions.add-assets": "Neue Dateien hinzuf\xFCgen",
  ...
  "input.placeholder": "Klicke hier, um eine Datei auszuw\xE4hlen oder Drag & Drop eine Datei in diesen Bereich.",
  ...
  "list.assets-empty.subtitle": "F\xFCge welche der Liste hinzu.",
  "list.assets-empty.title": "Keine Dateien vorhanden.",
  "list.assets-empty.title-withSearch": "Es existieren keine Dateien f\xFCr die gew\xE4hlten Filterkriterien.",
  "list.assets.empty": "Lade deine ersten Dateien hoch...",
  "list.assets.empty.no-permissions": "Die Datei-Liste ist leer.",
  "list.assets.loading-asset": "Lade die Vorschau f\xFCr Medien: {path}",
  "list.assets.not-supported-content": "Keine Vorschau verf\xFCgbar",
  "list.assets.preview-asset": "Vorschau f\xFCr das Video unter {path}",
  "list.assets.selected": "{number, plural, =0 {Keine Dateien} one {1 Datei} other {# Dateien}} bereits hochgeladen",
  "list.assets.type-not-allowed": "Dieser Dateityp ist nicht zul\xE4ssig.",
  "mediaLibraryInput.actions.nextSlide": "N\xE4chste Folie",
  "mediaLibraryInput.actions.previousSlide": "Vorherige Folie",
  "mediaLibraryInput.placeholder": "Klicke, um eine Datei hinzuzuf\xFCgen oder ziehe eine in diesen Bereich",
  ...
  "settings.form.responsiveDimensions.description": "Generiere automatisch mehrere Formate (klein, mittel, gro\xDF) der hochgeladenen Datei.",
  "settings.form.responsiveDimensions.label": "Automatische Formaterstellung aktivieren.",
  "settings.form.sizeOptimization.description": "Diese Einstellung wird die Gr\xF6\xDFe der Bilder reduzieren, daf\xFCr aber auch leicht die Bildqualit\xE4t verringern.",
  "settings.form.sizeOptimization.label": "Gr\xF6\xDFenoptimierung",
  ...
  "settings.sub-header.label": "Einstellungen f\xFCr die Medienbibliothek vornehmen",
  "sort.created_at_asc": "\xC4lteste Uploads",
  ...
  "sort.updated_at_asc": "\xC4lteste \xC4nderungen",
  "sort.updated_at_desc": "Neuste \xC4nderungen",
  "tabs.title": "Wie willst du deine Dateien hochladen?",
  "window.confirm.close-modal.file": "Bist du sicher? Deine \xC4nderungen gehen verloren.",
