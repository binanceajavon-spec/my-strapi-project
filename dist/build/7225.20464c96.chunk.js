"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[7225],{
...
const nl = {
  ...
  "Settings.tokens.copy.editMessage": "Voor veiligheidsredenen kun je je API Token maar \xE9\xE9n keer zien.",
  ...
  "Settings.permissions.conditions.no-actions": "Selecteer eerst acties (cre\xEBer, lees, update, ...) voordat je voorwaarden definieert.",
  ...
  "Settings.roles.create.title": "Cre\xEBer een rol",
  "Settings.roles.created": "Rol gecre\xEBerd",
  ...
  "Settings.roles.form.created": "Gecre\xEBerd",
  ...
  "Settings.roles.form.permissions.create": "Cre\xEBer",
  ...
  "Settings.sso.form.registration.description": "Cre\xEBer nieuwe gebruiker met SSO login als er nog geen account bestaat",
  ...
  "Settings.webhooks.events.create": "Cre\xEBer",
  ...
  "Settings.webhooks.trigger.title": "Opslaan v\xF3\xF3r het triggeren",
  ...
  "admin.pages.MarketPlacePage.plugin.installed": "Ge\xEFnstalleerd",
  ...
  "admin.pages.MarketPlacePage.plugin.version.null": 'Kan compatibiliteit met uw Strapi-versie niet verifi\xEBren: "{strapiAppVersion}"',
  ...
  "admin.pages.MarketPlacePage.filters.categoriesSelected": "{count, plural, =0 {Geen categorie\xEBn} one {# categorie} other {# categorie\xEBn}} geselecteerd",
  anErrorOccurred,
  ...
  "app.components.BlockLink.documentation.content": "Ontdek de essenti\xEBle concepten, handleidingen en instructies.",
  ...
  "app.components.GuidedTour.CM.create.content": "<p>Maak en beheer alle inhoud hier in de content manager.</p><p>Bijvoorbeeld: als we verder gaan met het blog-websitevoorbeeld, kan men een artikel schrijven, opslaan en publiceren zoals ze willen.</p>< p>\u{1F4A1} Snelle tip - Vergeet niet op publiceren te klikken bij de inhoud die u maakt.</p>",
  "app.components.GuidedTour.CM.create.title": "\u26A1\uFE0F Maak content",
  "app.components.GuidedTour.CM.success.content": "<p>Geweldig, nog een laatste stap te gaan!</p><b>\u{1F680}  Zie inhoud in actie</b>",
  "app.components.GuidedTour.CM.success.cta.title": "Test de API",
  "app.components.GuidedTour.CM.success.title": "Stap 2: Voltooid \u2705",
  "app.components.GuidedTour.CTB.create.content": "<p>Verzamelingstypen helpen u bij het beheren van meerdere inzendingen. Enkele typen zijn geschikt om slechts \xE9\xE9n inzending te beheren.</p> <p>Bijvoorbeeld: voor een blogwebsite zijn Artikelen een verzamelingstype, terwijl een startpagina een enkelvoudig type is. </p>",
  "app.components.GuidedTour.CTB.create.cta.title": "Een verzamelingstype bouwen",
  "app.components.GuidedTour.CTB.create.title": "\u{1F9E0} Een eerste collectietype maken",
  ...
  "app.components.GuidedTour.apiTokens.create.title": "\u{1F680} Zie inhoud in actie",
  ...
  "app.components.GuidedTour.home.CTB.title": "\u{1F9E0} Bouw de inhoudsstructuur",
  ...
  "app.components.HomePage.create": "Cre\xEBer je eerste Content-Type",
  "app.components.HomePage.roadmap": "Bekijk onze roadmap",
  "app.components.HomePage.welcome": "Welkom aan boord \u{1F44B}",
  "app.components.HomePage.welcome.again": "Welkom \u{1F44B}",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled": "Nog geen plugins ge\xEFnstalleerd",
  ...
  "app.components.PluginCard.Button.label.install": "Al ge\xEFnstalleerd",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description": "Een gebruiker kan \xE9\xE9n of meerdere rollen hebben",
  ...
  "app.components.listPlugins.title.none": "Geen plugins ge\xEFnstalleerd",
  ...
  "components.Input.error.contain.lowercase": "Wachtwoord moet op zijn minst \xE9\xE9n kleine letter bevatten",
  "components.Input.error.contain.number": "Wachtwoord moet op zijn minst \xE9\xE9n nummer bevatten",
  "components.Input.error.contain.uppercase": "Wachtwoord moet op zijn minst \xE9\xE9n hoofdletter bevatten",
  ...
  "content-manager.components.DynamicZone.ComponentPicker-label": "Kies \xE9\xE9n component",
  ...
  "content-manager.components.DynamicZone.missing-components": "Er {number, plural, =0 {zijn # missende componenten} one {is \xE9\xE9n # missend component} other {zijn # missende componenten}}",
  ...
  "content-manager.components.DynamicZone.pick-compo": "Kies \xE9\xE9n component",
  ...
  "content-manager.components.RepeatableComponent.error-message": "E\xE9n of meerdere componenten bevatten een fout",
  ...
  "content-manager.containers.Edit.information.created": "Gecre\xEBerd",
  ...
  "content-manager.notification.error.displayedFields": "Je hebt op z'n minst \xE9\xE9n weergegeven veld nodig.",
  "content-manager.notification.error.relationship.fetch": "Er is een fout opgetreden tijdens het ophalen van de relaties.",
  "content-manager.notification.info.SettingPage.disableSort": "Je hebt op z'n minst \xE9\xE9n attribuut nodig waar sorteren toegestaan is.",
  "content-manager.notification.info.minimumFields": "Je hebt op z'n minst \xE9\xE9n weergegeven veld nodig.",
  ...
  "content-manager.pages.NoContentType.button": "Cre\xEBer je eerste Content-Type",
  "content-manager.pages.NoContentType.text": "Je hebt nog geen content, we raden je aan je eerste Content-Type te cre\xEBeren.",
  ...
  "global.plugins.content-type-builder.description": "Modelleer de datastructuur van uw API. Cre\xEBer nieuwe velden en relaties in slechts een minuut. De bestanden worden automatisch aangemaakt en bijgewerkt in uw project.",
  ...
  "global.plugins.i18n.description": "Deze plug-in maakt het mogelijk om inhoud in verschillende talen te cre\xEBren, te lezen en bij te werken, zowel vanuit het beheerdersdashboard als vanuit de API.",
