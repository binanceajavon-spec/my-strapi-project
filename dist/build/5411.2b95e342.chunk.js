"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[5411],{
...
const es = {
  ...
  "filter.add": "A\xF1adir filtro",
  "form.button.replace-media": "Reemplazar multimedia",
  "form.input.decription.file-alt": "Este texto se mostrar\xE1 si el recurso no se puede mostrar.",
  "form.input.label.file-alt": "Texto alternativo",
  "form.input.label.file-caption": "Subt\xEDtulo",
  "form.input.label.file-name": "Nombre del archivo",
  "form.upload-url.error.url.invalid": "Una URL no es v\xE1lida",
  "form.upload-url.error.url.invalids": "{number} URL no son v\xE1lidas",
  ...
  "input.label": "Arrastra y suelta aqu\xED o",
  ...
  "input.url.description": "Separe sus enlaces URL con un salto de l\xEDnea.",
  "input.url.label": "URL",
  ...
  "list.assets-empty.title": "Todav\xEDa no hay recursos",
  ...
  "list.assets.empty.no-permissions": "La lista de recursos est\xE1 vac\xEDa.",
  ...
  "list.assets.selected": "{number, plural, =0 {Ning\xFAn recurso seleccionado} one {1 recurso seleccionado} other {# recursos seleccionados}}",
  "list.assets.type-not-allowed": "Este tipo de archivo no est\xE1 permitido.",
  "mediaLibraryInput.actions.nextSlide": "Siguiente",
  "mediaLibraryInput.actions.previousSlide": "Anterior",
  "mediaLibraryInput.placeholder": "Haga clic para seleccionar un activo o arrastre y suelte uno en esta \xE1rea",
  "mediaLibraryInput.slideCount": "{n} de {m}",
  "modal.file-details.date": "Fecha",
  "modal.file-details.dimensions": "Dimensiones",
  "modal.file-details.extension": "Extensi\xF3n",
  "modal.file-details.size": "Tama\xF1o",
  ...
  "modal.upload-list.sub-header.button": "Agregar m\xE1s recursos",
  "modal.upload.cancelled": "Subida anulada manualmente.",
  "page.title": "Configuraci\xF3n: biblioteca multimedia",
  "permissions.not-allowed.update": "No se le permite editar este archivo.",
  "plugin.description.long": "Gesti\xF3n de archivos multimedia.",
  "plugin.description.short": "Gesti\xF3n de archivos multimedia.",
  ...
  "settings.blockTitle": "Gesti\xF3n de recursos",
  "settings.form.autoOrientation.description": "Gire la imagen autom\xE1ticamente seg\xFAn la etiqueta de orientaci\xF3n EXIF",
  "settings.form.autoOrientation.label": "Habilitar la orientaci\xF3n autom\xE1tica",
  "settings.form.responsiveDimensions.description": "Genera autom\xE1ticamente m\xFAltiples formatos (grande, mediano, peque\xF1o) del recurso subido",
  "settings.form.responsiveDimensions.label": "Habilita la subida amigable",
  "settings.form.sizeOptimization.description": "Habilitar esta opci\xF3n optimizar\xE1 el tama\xF1o del archivo sin comprometer la calidad.",
  "settings.form.sizeOptimization.label": "Habilite la optimizaci\xF3n de tama\xF1o (sin p\xE9rdida de calidad)",
  "settings.form.videoPreview.description": "Generar\xE1 una vista previa de seis segundos del video (GIF)",
  "settings.form.videoPreview.label": "Vista previa",
  "settings.header.label": "Biblioteca de Multimedia - Configuraci\xF3n",
  ...
  "sort.created_at_asc": "Subidas m\xE1s antiguas",
  "sort.created_at_desc": "Subidas m\xE1s recientes",
  "sort.label": "Ordenar por",
  "sort.name_asc": "Orden alfab\xE9tico (de la A a la Z)",
  "sort.name_desc": "Orden alfab\xE9tico inverso (de la Z a la A)",
  "sort.updated_at_asc": "Actualizaciones m\xE1s antiguas",
  "sort.updated_at_desc": "Actualizaciones mas recientes",
  "tabs.title": "\xBFC\xF3mo desea cargar sus recursos?",
  "window.confirm.close-modal.file": "\xBFEst\xE1s seguro? Tus cambios se perder\xE1n.",
  "window.confirm.close-modal.files": "\xBFEst\xE1s seguro? Tiene algunos archivos que a\xFAn no se han subido.",
  "upload.generic-error": "Ha ocurrido un error al subir el archivo. Por favor, int\xE9ntelo de nuevo.",
  ...
  "modal.move.success-label": "Los elementos han sido movidos con \xE9xito",
