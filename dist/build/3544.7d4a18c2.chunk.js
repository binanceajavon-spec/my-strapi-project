"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[3544],{
...
const de = {
  ...
  "EditForm.inputSelect.label.role": "Standardrolle f\xFCr authentifizierte Benutzer",
  ...
  "EditForm.inputToggle.description.email-confirmation": "Wenn aktiviert (ON) erhalten neu registrierte Benutzer eine Best\xE4tigungs-E-Mail.",
  "EditForm.inputToggle.description.email-confirmation-redirection": "Nachdem Sie die E-Mail best\xE4tigt haben, w\xE4hle wohin sie weitergeleitet wird.",
  "EditForm.inputToggle.description.email-reset-password": "URL deiner Passwort-Zur\xFCcksetzen-Seite deiner Anwendung",
  ...
  "EditForm.inputToggle.label.email-reset-password": "Passwort-Zur\xFCcksetzen-Seite",
  "EditForm.inputToggle.label.sign-up": "Registration erm\xF6glichen",
  "Email.template.email_confirmation": "Best\xE4tigung der E-Mail-Addresse",
  ...
  "Plugin.permissions.plugins.description": "Definiere die m\xF6glichen Aktionen des {name} Plugins.",
  ...
  "Policies.header.hint": "W\xE4hle eine Aktion aus und klicke auf das Zahnrad, um den an diese Aktion gebundenen Pfad anzuzeigen",
  "Policies.header.title": "Fortgeschrittene Einstellungen",
  "PopUpForm.Email.email_templates.inputDescription": "{link} f\xFCr mehr Informationen",
  ...
  "PopUpForm.Email.options.object.placeholder": "Bitte best\xE4tige deine E-Mail-Adresse f\xFCr %APP_NAME%",
  ...
  "PopUpForm.Providers.redirectURL.label": "Die Weiterleitungs-URL f\xFCr die App-Einstellungen von {provider}",
  ...
  "Settings.roles.deleted": "Rolle gel\xF6scht",
  ...
  "plugin.description.long": "Besch\xFCtze deine API mit einem vollst\xE4ndigen Authentifikationsprozess basierend auf JWT. Zudem bietet dieses Plugin eine ACL-Strategie, die erlaubt, die Berechtigungen f\xFCr Benutzergruppen festzulegen.",
  "plugin.description.short": "Besch\xFCtze deine API mit einem vollst\xE4ndigen Authentifikationsprozess basierend auf JWT.",
  "plugin.name": "Nutzer- & Berechtigungen-Plugin",
  "popUpWarning.button.cancel": "Abbrechen",
  "popUpWarning.button.confirm": "Best\xE4tigen",
  "popUpWarning.title": "Bitte best\xE4tigen",
  "popUpWarning.warning.cancel": "Willst du wirklich alle deine \xC4nderungen verwerfen?"
};
