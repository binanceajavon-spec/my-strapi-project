"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[8657],{
...
const en = {
  ...
  "Settings.application.customization.size-details": "Max dimension: {dimension}\xD7{dimension}, Max file size: {size}KB",
  ...
  "app.components.GuidedTour.CM.create.content": "<p>Create and manage all the content here in the Content Manager.</p><p>Ex: Taking the Blog website example further, one can write an Article, save and publish it as they like.</p><p>\u{1F4A1} Quick tip \u2014 Don't forget to hit publish on the content you create.</p>",
  "app.components.GuidedTour.CM.create.title": "\u26A1\uFE0F Create content",
  "app.components.GuidedTour.CM.success.content": "<p>Awesome, one last step to go!</p><b>\u{1F680} See content in action</b>",
  ...
  "app.components.GuidedTour.CTB.create.title": "\u{1F9E0} Create a first Collection Type",
  ...
  "app.components.GuidedTour.apiTokens.create.title": "\u{1F680} See content in action",
  ...
  "app.components.GuidedTour.home.CTB.title": "\u{1F9E0} Build the content structure",
  ...
  "app.components.HomePage.welcome": "Welcome on board \u{1F44B}",
  "app.components.HomePage.welcome.again": "Welcome \u{1F44B}",
