"use strict";
(self["webpackChunkmy_strapi_project"] = self["webpackChunkmy_strapi_project"] || []).push([[2947],{
...
/* harmony export */ });
const ca = {
  "apiError.FileTooBig": "El fitxer supera la mida m\xE0xima permesa.",
  "bulk.select.label": "Seleccioneu tots els fitxers",
  "button.next": "Seg\xFCent",
  "checkControl.crop-duplicate": "Duplica i retalla l'imatge",
  "checkControl.crop-original": "Retalla l'imatge original",
  "content.isLoading": "S'est\xE0 carregant la llista de fitxers.",
  "control-card.add": "Afegeix",
  "control-card.cancel": "Cancel\xB7lar",
  "control-card.copy-link": "Copia l'enlla\xE7",
  ...
  "form.button.replace-media": "Substitu\xEFu els fitxers",
  "form.input.decription.file-alt": "Aquest text es mostrar\xE0 si el recurs no es pot mostrar.",
  "form.input.label.file-alt": "Text alternatiu",
  "form.input.label.file-caption": "Subt\xEDtol",
  "form.input.label.file-name": "Nom de l'arxiu",
  "form.upload-url.error.url.invalid": "Un URL no \xE9s v\xE0lid",
  "form.upload-url.error.url.invalids": "{number} URL no s\xF3n v\xE0lids",
  ...
  "input.label": "Arrossega i deixa anar aqu\xED o",
  "input.label-bold": "Arrossegar i deixar anar",
  "input.label-normal": "per carregar o",
  "input.placeholder": "Feu clic per afegir un fitxer o arrossegueu i deixeu anar un fitxer en aquesta \xE0rea",
  "input.placeholder.icon": "Deixeu el fitxer en aquesta zona",
  "input.url.description": "Separeu els vostres enlla\xE7os URL mitjan\xE7ant un retorn de carro.",
  "input.url.label": "URL",
  ...
  "list.assets.empty.no-permissions": "La llista de fitxers est\xE0 buida.",
  "list.assets.loading-asset": "S'est\xE0 carregant la previsualitzaci\xF3 dels mitjans: {path}",
  "list.assets.not-supported-content": "No hi ha vista pr\xE8via disponible",
  "list.assets.preview-asset": "Vista pr\xE8via del v\xEDdeo al cam\xED {path}",
  ...
  "list.assets.type-not-allowed": "Aquest tipus de fitxer no est\xE0 perm\xE8s.",
  ...
  "mediaLibraryInput.actions.nextSlide": "Seg\xFCent diapositiva",
  "mediaLibraryInput.actions.previousSlide": "Diapositiva anterior",
  "mediaLibraryInput.placeholder": "Feu clic per afegir un fitxer o arrossegueu-ne un en aquesta \xE0rea",
  "mediaLibraryInput.slideCount": "{n} de {m} diapositives",
  "modal.file-details.date": "Data",
  "modal.file-details.dimensions": "Dimensions",
  "modal.file-details.extension": "Extensi\xF3",
  ...
  "modal.upload-list.sub-header.button": "Afegeix m\xE9s actius",
  "modal.upload.cancelled": "La c\xE0rrega s'ha avortat manualment.",
  "page.title": "Configuraci\xF3 - Mediateca",
  "permissions.not-allowed.update": "No teniu perm\xEDs per editar aquest fitxer.",
  "plugin.description.long": "Gesti\xF3 de fitxers multim\xE8dia.",
  "plugin.description.short": "Gesti\xF3 de fitxers multim\xE8dia.",
  ...
  "settings.blockTitle": "Gesti\xF3 de fitxers",
  "settings.form.autoOrientation.description": "Si activeu aquesta opci\xF3, la imatge girar\xE0 autom\xE0ticament segons l'etiqueta d'orientaci\xF3 EXIF.",
  "settings.form.autoOrientation.label": "Orientaci\xF3 autom\xE0tica",
  "settings.form.responsiveDimensions.description": "Si activeu aquesta opci\xF3, es generaran diversos formats (petit, mitj\xE0 i gran) del recurs penjat.",
  "settings.form.responsiveDimensions.label": "C\xE0rrega amigable responsiva",
  "settings.form.sizeOptimization.description": "Activar aquesta opci\xF3 reduir\xE0 la mida de la imatge i la qualitat lleugerament.",
  "settings.form.sizeOptimization.label": "Optimitzaci\xF3 de la mida",
  "settings.form.videoPreview.description": "Generar\xE0 una previsualitzaci\xF3 de sis segons del v\xEDdeo (GIF)",
  "settings.form.videoPreview.label": "Vista pr\xE8via",
  "settings.header.label": "Mediateca",
  "settings.section.doc.label": "Doc",
  "settings.section.image.label": "Imatge",
  "settings.section.video.label": "V\xEDdeo",
  "settings.sub-header.label": "Configureu la configuraci\xF3 de la mediateca",
  "sort.created_at_asc": "C\xE0rregues m\xE9s antigues",
  "sort.created_at_desc": "C\xE0rregues m\xE9s recents",
  "sort.label": "Ordenar per",
  "sort.name_asc": "Ordre alfab\xE8tic (A a Z)",
  "sort.name_desc": "Ordre alfab\xE8tic invers (de la Z a la A)",
  "sort.updated_at_asc": "Actualitzacions m\xE9s antigues",
  "sort.updated_at_desc": "Actualitzacions m\xE9s recents",
  "tabs.title": "Com vols pujar els teus actius?",
  "window.confirm.close-modal.file": "Est\xE0s segur? Els vostres canvis es perdran.",
  "window.confirm.close-modal.files": "Est\xE0s segur? Teniu alguns fitxers que encara no s'han penjat."
};
